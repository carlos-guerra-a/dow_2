...
@section('contenido')
    ...
    <div class="artist-cards">
        @foreach ($imagenes as $imagen)
            <div class="artist-card" data-artista="{{ $imagen->cuenta->user }}">
                <img src="{{ asset('storage/'.$imagen->archivo) }}" alt="Imagen">
                <div class="artist-name">{{ $imagen->cuenta->nombre }} {{ $imagen->cuenta->apellido }}</div>
            </div>
        @endforeach
    </div>
